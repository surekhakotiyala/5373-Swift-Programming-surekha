...
class ColorTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        //self.view.backgroundColor = UIColor(patternImage: UIImage(named: "transparentimage.png"))
        // let image1 = UIImage (named: "transparentimage.png")
        //cell.backgroundView = UIImageView(image: image1)
        /* NSDictionary *item = (NSDictionary *)[self.content objectAtIndex:indexPath.row]
        NSString *path = [[NSBundle ainBundle] pathForResource:[item objectForKey:@"transparentimage"] ofType:@"png"]
        UIImage *theImage = [UIImage imageWithContentsOfFile:path]*/
        cell.imageView?.backgroundColor = myColors.hexStringToUIColor(myColors.fetchHexValue(name))
        cell.imageView?.image = UIImage(named: "tsp.png")
        return cell
    }
